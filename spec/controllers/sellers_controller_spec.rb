  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved seller as @seller" do
        ...
        post :create, {:seller => { "company_name" => "invalid value" }}, valid_session
        assigns(:seller).should be_a_new(Seller)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested seller" do
        ...
        Seller.any_instance.should_receive(:update_attributes).with({ "company_name" => "MyString" })
        put :update, {:id => seller.to_param, :seller => { "company_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the seller as @seller" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Seller.any_instance.stub(:save).and_return(false)
        put :update, {:id => seller.to_param, :seller => { "company_name" => "invalid value" }}, valid_session
        assigns(:seller).should eq(seller)
      end
